...
//      [[InvoiceTableViewController alloc] init];
//
//  // TODO: need to determine selected project some other way
//  [invoiceViewController
//      setSelectedProject:[[appDelegate clientProjects] objectAtIndex:index]];
//
//  [self.navigationController pushViewController:invoiceViewController
//                                       animated:YES];
//}
//
...
//
//  Invoice *rInvoice =
//      (Invoice *)[_invoicesForClient objectAtIndex:[indexPath row]];
//
