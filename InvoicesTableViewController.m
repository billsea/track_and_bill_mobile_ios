...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ClientInvoicesTableViewController *clientInvoicesController = [[ClientInvoicesTableViewController alloc] initWithNibName:@"ClientInvoicesTableViewController" bundle:nil];
    ...
    [self.navigationController pushViewController:clientInvoicesController animated:YES];
}
