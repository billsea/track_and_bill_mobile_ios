...
- (IBAction)addClient:(id)sender {
  AddClientTableViewController *addClientView =
      [[AddClientTableViewController alloc] init];
...
- (NSString *)pathForClientsFile {
  ...
  NSLog(@"path....%@",
        [NSString stringWithFormat:@"%@/%@", path, @"clients.tbd"]);
...
- (void)tableView:(UITableView *)tableView
  ...
  if (editingStyle == UITableViewCellEditingStyleDelete) {
    ...
    [self removeProjectsForClient:[[appDelegate arrClients]
...
- (void)tableView:(UITableView *)tableView
  ...
  [projectsViewController setSelectedClient:[[appDelegate arrClients]
                                                objectAtIndex:[indexPath row]]];
