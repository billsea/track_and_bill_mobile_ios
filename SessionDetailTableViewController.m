...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  UILabel *cellLabel = [[UILabel alloc]
      initWithFrame:CGRectMake(11, 11, cell.frame.size.width - 100, 21)];

  [cellLabel setFont:[UIFont fontWithName:@"Avenir Next Medium" size:21]];
  [cellLabel setTextColor:[UIColor blackColor]];

  UISwitch *tSwitch =
      [[UISwitch alloc] initWithFrame:CGRectMake(screenWidth - 65, 6, 30, 30)];
...
- (void)tableView:(UITableView *)tableView
  ...
  case 1:
    ...
    milageViewController =
        [[MilageViewController alloc] initWithNibName:@"MilageViewController"
                                               bundle:nil];
    [milageViewController setSelectedSession:_selectedSession];
    [self.navigationController pushViewController:milageViewController
                                         animated:YES];
    break;
  case 2:
    // Pass the selected object to the new view controller.
    notesViewController = [[SessionNotesViewController alloc]
  ...
  case 3:
    // Pass the selected object to the new view controller.
    materialsViewController = [[MaterialsViewController alloc]
        initWithNibName:@"MaterialsViewController"
                 bundle:nil];
    [materialsViewController setSelectedSession:_selectedSession];
    [self.navigationController pushViewController:materialsViewController
                                         animated:YES];
    break;
  //        case 3:
  //            // Remove Session
