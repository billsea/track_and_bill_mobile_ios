...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[cell labelCell] setText:[[_clientFormFields objectAtIndex:[indexPath row]] valueForKey:@"FieldName"]];
...
{
    if(!_userData){
        _userData = [[NSMutableArray alloc] initWithCapacity:[_clientFormFields count]];
